export default function CategoryCard({ category, onSelect }) {
  return (
    <button
      ...
      className="group relative text-left w-full min-h-60 p-6 rounded-2xl border border-white/8 bg-white/2.5 hover:bg-white/6 hover:border-white/20 transition-all duration-300 hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#38bdf8]"
